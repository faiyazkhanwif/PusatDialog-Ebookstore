<div class="container">
    <div class="my-form jumbotron shadow">
        <div id="form-header"><h4 style="font-family: Trebuchet MS; font-weight: bold;text-align: center; border-bottom: 1px solid black;">Add new user</h4></div>
        ...
        <div class="form-group">
            <label class="section-title" style="font-family: Helvetica; font-size: 15px; font-weight: bold" for="contact">Contact</label>
        ...
        <div class="form-group">
            <label class="section-title" style="font-family: Helvetica; font-size: 15px; font-weight: bold" for="email">E-mail</label>
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                <label class="section-title" style="font-family: Helvetica; font-size: 15px; font-weight: bold" for="password">Password</label>
            ...
            <div class="form-group col-md-6">
                <label class="section-title" style="font-family: Helvetica; font-size: 15px; font-weight: bold" for="repassword">Confirm Password</label>
        ...
        <div class="form-group">
            <label class="section-title" style="font-family: Helvetica; font-size: 15px; font-weight: bold" for="address">Address</label>
        ...
        <div class="form-group">
            <label class="section-title" style="font-family: Helvetica; font-size: 15px; font-weight: bold" for="city">City</label>
