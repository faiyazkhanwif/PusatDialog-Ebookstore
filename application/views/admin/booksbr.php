...
<div class="container-fluid">
    <div class="books-menu">
      <ul>
        <li><a href="<?= base_url()?>admin/booksbr"><i class="fas fa-book"></i> all E-books for borrow</a></li>
        <li><a href="<?= base_url()?>admin/add_booksbr"><i class="fas fa-plus-circle"></i> Add new E-book for borrow</a></li>        
      </ul>
  </div>
</div>
...
<br>
<div class="container-fluid">
	<div id="table-header">Books list (For Borrow)</div>
