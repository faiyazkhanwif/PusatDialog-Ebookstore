    ...
    <div class="col-lg-6">
        ...
        <p class="lead">
            <div style="text-align: center;">
             <a class="btn btn-primary btn-lg" style="box-shadow: 2px 2px #7DAECC;border-radius: 15px;padding: 5px 30px;" 
             href="<?= base_url('user-home/edit-profile/'.$this->session->userdata('id').'')?>" role="button">Edit Profile</a> 
         </div>
     </p>
