					...
					<div class="row">
						...
						<div class="col">
							<?php if ($this->session->userdata('logged_in')): ?>
								<?php if ($user_details->membershipstatus == "pro"): ?>
									<?php print '<a href = "'.base_url().'user-home/readbook/'.$book_detail->id.'" class="btn btn-outline-primary btn-sm">Read for free</a>'; ?>
								<?php endif ?>
							<?php endif ?>
