...
<div class="login-form-area">
    <div class="container">
        <div class="reg-form">
            <div class="form-header section-title" style="padding-top: 20px; border-bottom: .2px solid #BDC5CA;"><h4>Welcome to Pusat Dialog! Please fill up the registration form to sign up.</h4></div>
