<br>
<br>
<h1 class="text-center">Pro Membership</h1>
<br>

<div class="card-deck">
  <div class="card text-white bg-secondary">
    <div class="card-header text-center">Pro membership</div>
    <div class="card-body">
      <h2 class="card-title text-white text-center">RM 30</h2>
      <br>
  ...
  <div class="card text-white bg-info">
    <div class="card-header text-center">Pro membership</div>
    <div class="card-body">
      <h2 class="card-title text-white text-center">RM 80</h2>
      <br>
  ...
  <div class="card text-white bg-primary">
    <div class="card-header text-center">Pro membership</div>
    <div class="card-body">
      <h2 class="card-title text-white text-center">RM 150</h2>
      <br>
